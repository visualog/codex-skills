...
Clone this repository, then copy the two skill directories into Codex's global skill directory:
...
Restart Codex if it does not recognize the new skills immediately. Invoke them in the desktop app with `@project-operating-system` or `@codex-deep-research`; use `$skill-name` in the CLI or IDE.
